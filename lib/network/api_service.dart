...
class ApiService {
  ...
  static Future<Response> getBooks({String? categoryId}) async {
    final response = await getRequest(
      endpoint: ApiEndpoint.GET_BOOK + "/" + categoryId!,
    );
    return response;
  }

  static Future<dynamic> getAllBooks() async {
    var response = await getRequest(endpoint: ApiEndpoint.GET_BOOK);
    return response;
  }
}
