...
import 'widget/learning_zone_web_body.dart';

class LearningZoneWeb extends StatelessWidget {
  const LearningZoneWeb({Key? key}) : super(key: key);
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    LanguageConstants.learningZone,
